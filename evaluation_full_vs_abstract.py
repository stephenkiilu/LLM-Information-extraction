...
DATA_GPT_4o_mini= "data/processed/whitematter_full_predicted_data_GPT_5_mini.csv"
DATA_GPT_4o_mini_abstract= "data/processed/whitematter_abstract_predicted_data_GPT_5_mini.csv"
...
results_gpt4 = evaluate_model(DATA_GPT_4o_mini, "full article")
results_gpt5 = evaluate_model(DATA_GPT_4o_mini_abstract,  "abstract only")
...
print("\n" + "=" * 70)
print("F1 COMPARISON — GPT-4o-mini (full article) vs GPT-4o-mini-abstract (abstract only)")
print("=" * 70)
...
models = ["full article", "abstract only"]
colors = {"full article": "#636EFA", "abstract only": "#EF553B"}
...
ax.set_title("GPT-5 full articles vs abstracts only",   
...
plt.tight_layout()
fig.savefig("data/processed/f1_comparison_gpt5_abstract_vs_gpt5_full.png", dpi=300, bbox_inches="tight")
plt.show()
